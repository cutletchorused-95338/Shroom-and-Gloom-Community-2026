...
# 🎮 Shroom and Gloom — Community Edition

**Deckbuilding meets first-person dungeon crawling in a fungal underworld.**
...
Shroom and Gloom is a first-person deckbuilding roguelike set in a fungal underground world. Players explore procedurally generated dungeons, build card decks for combat and healing, and face escalating challenges run after run. This Community Edition is a standalone build packaged as a self-contained package with no storefront required and no additional software required.

This standalone build is for players who enjoy roguelike deckbuilders and want a self-contained offline version playable immediately.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3271280/2f7d76d520d6e66f65f8ba0a753a5fa232e6b7d3/ss_2f7d76d520d6e66f65f8ba0a753a5fa232e6b7d3.1920x1080.jpg?t=1789418745" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3271280/b2718bf8a3a73a7661029cc95be207366b6e57b7/ss_b2718bf8a3a73a7661029cc95be207366b6e57b7.1920x1080.jpg?t=1789418745" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3271280/d35c20da471d04844aa8562b0008e919426c95aa/ss_d35c20da471d04844aa8562b0008e919426c95aa.1920x1080.jpg?t=1789418745" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🃏 **Deckbuilding Combat** — Build and refine card decks that drive both attack and defense in turn-based encounters.
- 🍄 **Fungal World** — Explore a mushroom-covered underground setting with a distinct visual identity.
- 🎲 **Roguelike Runs** — Procedurally generated dungeons ensure every run presents new layouts and challenges.
- 🧭 **First-Person Exploration** — Navigate dungeons from a first-person perspective, blending exploration with card battles.
- ❤️ **Healing Mechanics** — Cards serve dual roles, doubling as weapons and healing tools during runs.
- ⚔️ **Escalating Difficulty** — Enemies and bosses scale in complexity as runs progress deeper underground.
- 🏆 **Unlockable Content** — Includes all content, with cards, relics, and modifiers earned across runs.
- 💻 **Runs Offline** — Fully playable as an offline version with no storefront required.
- 📦 **Self-Contained Package** — Ships as an independent release with no additional software required.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~5 minutes on HDD
- **Recoding:** none
- **Selective Download:** Not applicable — full game included in a single self-contained package
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti or AMD Radeon RX 560 | NVIDIA GeForce GTX 1060 or AMD Radeon RX 580 |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\ShroomandGloom\Saved`
